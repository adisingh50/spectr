...
class EncoderDecoder(nn.Module):
    def __init__(self, k_width=3, pad=1) -> None:
        ...
        self.encoder_conv1 = nn.Conv2d(3, 64, kernel_size=k_width, stride=1, padding=pad)
        self.encoder_bn1 = nn.BatchNorm2d(64)

        self.encoder_conv2 = nn.Conv2d(64, 128, kernel_size=k_width, stride=1, padding=pad)
        self.encoder_conv3 = nn.Conv2d(128, 128, kernel_size=k_width, stride=1, padding=pad)
        self.encoder_bn2 = nn.BatchNorm2d(128)

        self.encoder_conv4 = nn.Conv2d(128, 256, kernel_size=k_width, stride=1, padding=pad)
        self.encoder_conv5 = nn.Conv2d(256, 256, kernel_size=k_width, stride=1, padding=pad)
        ...
        self.decoder_conv1 = nn.ConvTranspose2d(256, 256, kernel_size=k_width, stride=1, padding=pad)
        self.decoder_conv2 = nn.ConvTranspose2d(256, 128, kernel_size=k_width, stride=1, padding=pad)
        self.decoder_bn1 = nn.BatchNorm2d(256)
        self.decoder_bn2 = nn.BatchNorm2d(128)

        self.decoder_conv3 = nn.ConvTranspose2d(128, 128, kernel_size=k_width, stride=1, padding=pad)
        self.decoder_conv4 = nn.ConvTranspose2d(128, 64, kernel_size=k_width, stride=1, padding=pad)
        self.decoder_bn3 = nn.BatchNorm2d(64)

        self.decoder_conv5 = nn.ConvTranspose2d(64, 64, kernel_size=k_width, stride=1, padding=pad)
